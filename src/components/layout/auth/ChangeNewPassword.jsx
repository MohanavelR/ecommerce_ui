...
async function handlechangePassword(){
 ...
 if(!localError.confirm_password.isRequired && !localError.password.length_error && !localError.password.isRequired && formData.confirm_password!==formData.password){
  ...
  return (
    ...
    <div className='flex flex-col space-y-4'>
     <div>
         ...
         <i className="fas fa-lock absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground w-5 h-5"></i>
            ...
            />
            {
              fieldErrros.password.isRequired && <p className='text-xs  font-medium text-red-700'>Password is Required</p>
            }
            {
              fieldErrros.password.length_error && <p className='text-xs  font-medium text-red-700'>Password is must be 8 charators</p>
            }
     ...
     <div>
         ...
         <i className="fas fa-lock absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground w-5 h-5"></i>
            ...
            />
            {
              fieldErrros.confirm_password.isRequired && <p className='text-xs  font-medium text-red-700'>Confirm password is Required</p>
            }
            {
              fieldErrros.confirm_password.match_error&& <p className='text-xs  font-medium text-red-700'> password doesn't Match</p>
            }
          </div>
    </div>
    <div className='flex space-x-3'>
      ...
      <input
            ...
            />
             <label htmlFor="" className='block text-sm/6 font-medium text-gray-900'>Show Password</label>
    </div>
    <button onClick={handlechangePassword} className='btn-hero mt-3'>Change Password</button>
    </div>
    </>
  )
}
