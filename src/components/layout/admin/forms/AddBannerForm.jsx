          ...
          <form className="p-6 space-y-6" id="categoryForm" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="mt-4">
                  ...
                  <div id="imagesContainer" className="space-y-3">
                    ...
                    <div className="relative">
                      ...
                      >
                        {/* */}
                        <svg
                          className="w-12 h-12 mb-2 text-gray-500" // Icon color set to match original gray theme
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                ...
                {formData?.image &&
                  ...
                  <div className="mt-3 border border-gray-300 rounded-lg p-3 max-w-sm mx-auto">
                    ...
                    <img src={formData?.image} alt="Banner Preview" className="rounded w-full h-auto object-cover" />
                  </div>
                }
            ...
            <div className="flex justify-end space-x-3 items-center pt-4 border-t border-gray-200">
              <button
                ...
                type="button"
                // Updated secondary button style for cleaner look
              ...
              >
               ...
               {
                isUpload ?<Loader/>:
                isEditMode ? "Update Poster" : "Save Poster" 
               }
              </button>
            </div>
          </form>
