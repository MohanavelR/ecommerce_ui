...
const AdminSidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const navigation = [
    { name: "Dashboard", href: "/admin/dashboard", icon: <i className="fas fa-chart-line"></i>},
    { name: "Products", href: "/admin/products", icon: <i className="fas fa-box"></i>},
    { name: "Categories", href: "/admin/categories", icon: <i className="fas fa-tags"></i> },
    { name: "Orders", href: "/admin/orders", icon: <i className="fas fa-shopping-cart"></i> },
    { name: "Users", href: "/admin/customers", icon:  <i className="fas fa-users"></i> },
    { name: "Ad/Banners", href: "/admin/ad-banner", icon: <i className="fas fa-chart-bar"></i> },
    { name: "Slider", href: "/admin/slider", icon:<i className="fas fa-image"></i> },
    { name: "Coming soon", href: "/admin/coming-soon", icon: <i className="fas fa-clock"></i>},
  ];
  ...
  return (
    <>
      ...
      >
        ...
        <div onClick={() => setSidebarOpen(false)} className='absolute lg:hidden cursor-pointer right-2 top-2 z-10'>
          <CloseBtn />
        </div> 
