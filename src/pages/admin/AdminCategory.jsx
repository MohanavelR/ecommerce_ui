...
const AdminCategory = () => {
  ...
  async function handleCategoryMethod(e) {
    ...
    if (!hasError) {
      dispatch(
        isEditMode
          ? useUpdateCategory({ id: formData._id, formData })
          : useCreateCategory(formData)
      ).then((res) => {
  ...
  return (
    <>
      {openCategoryForm && (
        <AddCategory
          handleCategoryMethod={handleCategoryMethod}
          fielderrors={fielderrors}
          closeCategoryFormMethod={closeCategoryFormMethod}
          formData={formData}
