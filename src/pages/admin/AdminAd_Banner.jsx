...
import { useCreateBanner, useDeleteBanner, useGetAllBanners, useUpdateBanner } from '../../store/admin/adbanner'
...
console.log(banners)
  ...
  return (
    <div>
      {
        openForm && <AddBannerForm isEditMode={isEditMode} setFormData={setFormData} closeFormMethod={closeFormMethod} handleFormMethod={handleFormMethod} fielderrors={fielderrors} formData={formData}  />
      }
      {
        isLoading ?<Loader/>:
        <div>
...
<BannerTable banners={banners} handleDeleteBanner={handleDeleteBanner} setIsEditModeMethod={setIsEditModeMethod} />
        </div>
      }
    </div>
  )
