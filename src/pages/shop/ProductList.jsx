      ...
      <div>
        ...
        <div className="flex space-x-2">
          ...
          <div className="p-4 sm:p-6 mt-9  w-full bg-white relative  rounded-xl shadow-2xl">
            {" "}
            {/* Main container is a clean, lifted card */}
            <header className="mb-6 mt-3 flex justify-between border-accent  items-baseline border-b pb-4">
              <button
                ...
                className="text-white md:hidden text-xs  absolute right-[0%] -top-5 hover-duration hover:bg-cyan-700  bg-cyan-800 px-4 py-3 rounded-lg font-bold"
              >
                <i className="fa-solid fa-filter"></i> Filter
              </button>{" "}
              <h1 className="md:text-xl text-base  font-extrabold tracking-tight text-gray-900">
                Shopping Products
              </h1>
